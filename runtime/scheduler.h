...
/* Spawn a new coroutine running fn(arg). Returns immediately.
 * The new coroutine is pushed onto the current worker's deque. */
TyCoro* ty_spawn(void (*fn)(void* arg), void* arg);
