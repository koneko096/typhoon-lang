...
static TyCoro* coro_new(void (*fn)(void*), void* arg) {
...
TyCoro* ty_spawn(void (*fn)(void*), void* arg) {
...
void ty_chan_send(TyChan* ch, void* elem) {
...
void ty_chan_recv(TyChan* ch, void* out) {
    ty_mutex_lock(&ch->lock);
    if (ch->len > 0) {
